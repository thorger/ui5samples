...
sap.ui.define([
	"jquery.sap.global",
	"nw/epm/refapps/lib/reuse/library",
	"sap/ui/core/Control"
	 ...
	 * @constructor
	 * @public
	 * @alias nw.epm.refapps.lib.reuse.control.RatingAndCount
	 */
	var RatingAndCount = Control.extend("nw.epm.refapps.lib.reuse.control.RatingAndCount", {
		metadata: {
			library: "nw.epm.refapps.lib.reuse",
			properties: {
				/**
				 * maxRatingValue
				 */
