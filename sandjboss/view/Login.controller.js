(function() {
  ...
  sap.ui.core.mvc.Controller.extend("sap.ui.ipw.ViewApp.view.Login", {
    ...
    authenticate: function(sUsername, sPassword, fnSuccess, fnError) {
      ...
      var isCurrentlySuccessful = false;
      
      this.sCurrentUserContext = sUsername;
      jQuery.ajax({
        url: "/ipw/quo/login.do",
        async: false,
        type: "POST",
        data: {
          "Dialog": "authenticate",
        ...
        success: function(data, textStatus, jqXHR) {
          isCurrentlySuccessful = true;
        },
        error: function(err) {
          isCurrentlySuccessful = false;
    ...
    goToMainPage: function() {
     ...
     var sLaunchPadUrl;
      ...
      if(window.parent.location.href.indexOf( "test") > -1){
          sLaunchPadUrl = "http://localhost:8080/ipw-launch-pad/sandbox/fioriSandbox.html";
      }
      else{
          sLaunchPadUrl = "sandbox/fioriSandbox.html";
      }
