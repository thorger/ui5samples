...
sap.ui.define([
	...
	"./utilities"
], function(Controller, History, utilities) {
	"use strict";

	return Controller.extend("nw.epm.refapps.ext.shop.controller.BaseController", {
		/**
		...
		onNavBack: function() {
			...
			if (typeof sPreviousHash !== "undefined") {
				...
				var bReplace = true;
				this.getRouter().navTo("ProductList", {}, bReplace);
			}
		}
