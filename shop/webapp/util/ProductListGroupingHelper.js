sap.ui.define([
	...
	return Object.extend("nw.epm.refapps.ext.shop.util.ProductListGroupingHelper", {
		...
		openGroupingDialog: function() {
			if (!this._oGroupDialog) {
				this._oGroupDialog = sap.ui
					.xmlfragment("nw.epm.refapps.ext.shop.view.fragment.ProductGroupingDialog", this);
				// switch the dialog to compact mode if the hosting view has compact mode
				jQuery.sap.syncStyleClass("sapUiSizeCompact", this._oView, this._oGroupDialog);
